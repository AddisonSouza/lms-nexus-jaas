...
- [ ] Trocar o raio do primitivo `Card` para `rounded-[var(--radius-md)]` (#94)
- [ ] Garantir o recorte dos cantos nas listas em tabela (hover da linha não vaza) (#95)
- [ ] Rodar lint, type-check e testes do `apps/web` (#96)
