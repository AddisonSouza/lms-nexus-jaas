...
### Requirement: REQ-INV-01 — Convidar membro por e-mail
...
### Requirement: REQ-INV-02 — Aceitar convite
...
### Requirement: REQ-INV-03 — Remover membro
`ADMIN_ORG` pode remover qualquer membro da organização exceto a si mesmo (ADMIN_ORG criador). Remoção aplica soft delete em `organization_members` (seta `deleted_at`).
...
#### Scenario: Tentativa de remover o próprio ADMIN_ORG criador
...
### Requirement: REQ-INV-04 — Frontend: página de aceite de convite
